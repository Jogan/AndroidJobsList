 ...
 * in a {@link com.androidjobslist.app.ui.JobListActivity}.
 * <p>
...
public class JobDetailActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putSerializable(JobDetailFragment.ARG_JOB_SERIALIZABLE, getIntent().getSerializableExtra(JobDetailFragment.ARG_JOB_SERIALIZABLE));
